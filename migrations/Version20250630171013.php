 ...
 */
final class Version20250630171013 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE breed (id INT AUTO_INCREMENT NOT NULL, pet_type_id INT NOT NULL, name VARCHAR(255) NOT NULL, is_dangerous TINYINT(1) DEFAULT 0 NOT NULL, INDEX IDX_F8AF884FDB020C75 (pet_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE pet (id INT AUTO_INCREMENT NOT NULL, type_id INT NOT NULL, breed_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, date_of_birth DATE DEFAULT NULL, age INT DEFAULT NULL, sex VARCHAR(255) DEFAULT NULL, is_dangerous TINYINT(1) DEFAULT 0 NOT NULL, breed_choice VARCHAR(255) DEFAULT NULL, breed_other LONGTEXT DEFAULT NULL, INDEX IDX_E4529B85C54C8C93 (type_id), INDEX IDX_E4529B85A8B4A30F (breed_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
